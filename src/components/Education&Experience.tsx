            ...
            <Box sx={{
                ...
                <Box sx={{
                    ...
                    <Box sx={{
                        ...
                        >
                            <Grid item xs={12} sm={6} md={3} sx={{ padding: { xs: '20px 20px', md: '0 20px'}}}>
                                <Card sx={{
                                    maxWidth: 345,
                                    minHeight: 245,
                            ...
                            <Grid item xs={12} sm={6} md={3} sx={{ padding: { xs: '60px 20px', sm:'20px 20px', md: '0 20px' } }}>
                                <Card sx={{
                                    maxWidth: 345,
                                    minHeight: 245,
                                    backgroundImage: `url(${BgCard})`,
                            ...
                            <Grid item xs={12} sm={6} md={3} sx={{ padding: { xs: '20px 20px', sm:'60px 20px', md: '0 20px' } }}>
                                <Card sx={{
                                    maxWidth: 345,
                                    minHeight: 245,
                                    backgroundImage: `url(${BgCard})`,
                            ...
                            <Grid item xs={12} sm={6} md={3} sx={{ padding: { xs: '60px 20px 0', sm:'60px 20px', md: '0 20px' } }}>
                                <Card sx={{
                                    maxWidth: 345,
                                    minHeight: 245,
                                    backgroundImage: `url(${BgCard})`,
